...
urlpatterns = [
    ...
    path("brands/<int:pk>/details/", views.BrandDetailsView.as_view(), name="brand_details"),
    ...
    path("api/v1/brands/<int:pk>/", views.BrandRetrieveUpdateDestroyAPIView.as_view(), name="brand-details-api-view")
]
